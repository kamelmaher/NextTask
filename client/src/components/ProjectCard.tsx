...
export function ProjectCard({ project, link, canDelete }: ProjectCardProps) {
    ...
    return (
        <div className="group relative block rounded-2xl border border-border bg-surface p-6 transition-all hover:border-brand/30 hover:shadow-xl hover:shadow-brand/5">
            <NavLink
                to={url}
            >
                ...
                <div className="flex flex-wrap items-center justify-between gap-4">
                    ...
                    <div>
                        <div>
                            <span className="text-sm font-bold text-brand p-2">View Details →</span>
                        </div>
                    </div>
                </div>
            </NavLink>
